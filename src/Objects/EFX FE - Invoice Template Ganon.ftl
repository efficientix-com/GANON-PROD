                    ...
                    <tr height="70px">
                        ...
                        <td colspan="4" style="font-size: 10px;" align="right"><span style="font-size: 12px;"><strong>FACTURA</strong></span><br/>
                            <#if dataXML?has_content>
                                ...
                                <span class="number" style="font-size: 14px;">${folio_tran}</span>
    ...
    <#if dataXML?has_content>
                    ...
                    <td colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3; font-size:9px;">
                        ...
                        <#if dataXML.Receptor.atributos.RegimenFiscalReceptor?keep_before(" ") == "601">
                            ...
                            <#elseif dataXML.Receptor.atributos.RegimenFiscalReceptor?keep_before(" ") == "626">
                                ...
                                <br /><b> Regimen Fiscal:</b> ${reg_fiscal?upper_case}
                            <#else>
                                <br /><b> Regimen Fiscal:</b> ${dataXML.Receptor.atributos.RegimenFiscalReceptor?upper_case}
                            </#if>
                    </td>
                    <td></td>
        ...
        <#else>
            <table style="width: 100%; margin-top: 10px;">
                ...
                <tr>
                <#if record.custbody_efx_fe_gbl_clientesucursal?has_content>
                <td colspan="14" rowspan="2" style="border: 1px; border-color: #e3e3e3; font-size:9px;">
                    ${record.custbody_efx_fe_gbl_clientesucursal}<br/><br/>
                    <b>RFC:</b> <#outputformat "XML">${dataXML.Receptor.atributos.Rfc}</#outputformat><br />
                    <#if dataXML.Receptor.atributos.RegimenFiscalReceptor?keep_before(" ") == "601">
                            <#assign reg_fiscal = "601 - General de Ley Personas Morales">
                            <br /><b>Regimen Fiscal:</b> ${reg_fiscal?upper_case}
        ...
        <table class="itemtable" style="width: 100%; margin-top: 3px; border: 1px; border-color: #e3e3e3;">
            <#if dataXML.Conceptos.Concepto?is_sequence>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="5"
                        style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Clave<br/>Código
                    </th>
                ...
                <#assign linexml = 0>
                  <#assign linexmlNetsuite = 0>
                <#list dataXML.Conceptos.Concepto as Conceptos>
                  		<#if record.item[linexmlNetsuite].itemtype == "Discount">
                        	<#assign codigoclave = record.item[(linexmlNetsuite)+1].item>
                              <#assign linexmlNetsuite = linexmlNetsuite+2>
                        <#else>
                          <#assign codigoclave = record.item[linexmlNetsuite].item>
                            <#assign linexmlNetsuite = linexmlNetsuite+1>
                        </#if>
                    ...
                    <tr>
                      ...
                      <#assign claveprodcodigo = codigoclave + "<br />" +Conceptos.atributos.ClaveProdServ>
                        <td align="left" colspan="5" line-height="150%"
                            style="border-left: 1px; border-color: #e3e3e3;font-size: 5pt; padding:0;">${claveprodcodigo}</td>
            ...
            <#else>
                ...
                <tr style="margin-top: 0px; padding-top: 0px; padding-bottom: 0px">
                    ...
                    <th align="center" colspan="5" style="font-size: 5pt; padding-left: 0px; padding-right: 0px;">Clave<br/>Código
                    </th>
